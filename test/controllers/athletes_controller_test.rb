...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { birthDate: @athlete.birthDate, email: @athlete.email, idClub: @athlete.idClub, idCountry: @athlete.idCountry, lastName: @athlete.lastName, name: @athlete.name, sex: @athlete.sex } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { birthDate: @athlete.birthDate, email: @athlete.email, idClub: @athlete.idClub, idCountry: @athlete.idCountry, lastName: @athlete.lastName, name: @athlete.name, sex: @athlete.sex } }
